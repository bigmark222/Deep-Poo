//! Thin interface layer for the vision/ML stack.
//!
//! These traits are intentionally minimal so we can plug in different frame
//! sources (GPU capture, video files), detectors (Burn model, heuristic), and
//! recorders (disk, streaming) under feature flags without entangling the core
//! sim.
